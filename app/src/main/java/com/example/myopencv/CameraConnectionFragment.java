...
import com.example.myopencv.model.AutoFitTextureView;
            ...
            new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureProgressed(
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        Log.d("Tuanna-onCaptureProgressed", partialResult.getCameraId());
                    }
                }
                ...
                public void onCaptureCompleted(
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        Log.d("Tuanna-onCaptureProgressed", result.getCameraId());
                    }
                }
            };
    ...
    private final TextureView.SurfaceTextureListener surfaceTextureListener =
            new TextureView.SurfaceTextureListener() {
                ...
                public void onSurfaceTextureAvailable(
                    ...
                    Log.d(TAG, "open camera with size  = " + width + " x " + height);
                ...
                public void onSurfaceTextureSizeChanged(
                        final SurfaceTexture texture, final int width, final int height) {
                    Log.d(TAG, "onSurfaceTextureSizeChanged with size  = " + width + " x " + height);
    ...
    private final CameraDevice.StateCallback stateCallback =
            new CameraDevice.StateCallback() {
                ...
                public void onOpened(final CameraDevice cd) {
                    ...
                    Log.d(TAG, "opened camera with id  = " + cd.getId());
                ...
                public void onDisconnected(final CameraDevice cd) {
                    cameraOpenCloseLock.release();
                    Log.d(TAG, "closed camera with id  = " + cd.getId());
                    cd.close();
                    cameraDevice = null;
                }
                ...
                public void onError(final CameraDevice cd, final int error) {
                    cameraOpenCloseLock.release();
                    cd.close();
                    Log.d(TAG, "onError => exit app; camera with id  = " + cd.getId() + ", error code = " + error);
                    cameraDevice = null;
